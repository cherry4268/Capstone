...
# List of file paths
file_paths <- c(
  "Capstone/data/Transport/transport_mwA.csv",
  "Capstone/data/Transport/transport_mdBC.csv",
  "Capstone/data/Transport/transport_westA.csv",
  "Capstone/data/Transport/transport_westBC.csv",
  "Capstone/data/Transport/transport_southA.csv",
  "Capstone/data/Transport/transport_southBC.csv",
  "Capstone/data/Transport/transport_neA.csv",
  "Capstone/data/Transport/transport_neBC.csv"
)
